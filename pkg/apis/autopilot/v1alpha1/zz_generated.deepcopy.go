...
func (in *AutopilotRuleObjectStatus) DeepCopyInto(out *AutopilotRuleObjectStatus) {
	*out = *in
	...
	in.NextProcessTimestamp.DeepCopyInto(&out.NextProcessTimestamp)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutopilotRuleStatus) DeepCopyInto(out *AutopilotRuleStatus) {
	*out = *in
	if in.Objects != nil {
		in, out := &in.Objects, &out.Objects
		*out = make(map[RuleStatusObjectKey][]*AutopilotRuleObjectStatus, len(*in))
		for key, val := range *in {
			var outVal []*AutopilotRuleObjectStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]*AutopilotRuleObjectStatus, len(*in))
				for i := range *in {
					if (*in)[i] != nil {
						in, out := &(*in)[i], &(*out)[i]
						*out = new(AutopilotRuleObjectStatus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutopilotRuleStatus.
func (in *AutopilotRuleStatus) DeepCopy() *AutopilotRuleStatus {
	if in == nil {
		return nil
	}
	out := new(AutopilotRuleStatus)
	in.DeepCopyInto(out)
	return out
}
