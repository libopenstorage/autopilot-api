...
import (
	...
	autopilot "github.com/libopenstorage/autopilot-api/pkg/client/informers/externalversions/autopilot"
...
func (f *sharedInformerFactory) Autopilot() autopilot.Interface {
	return autopilot.New(f, f.namespace, f.tweakListOptions)
}
